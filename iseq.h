...
int iseq_add_mark_object_compile_time(const rb_iseq_t *iseq, VALUE v);
VALUE rb_iseq_compile_ifunc(rb_iseq_t *iseq, const struct vm_ifunc *ifunc);
int rb_iseq_translate_threaded_code(rb_iseq_t *iseq, int iseq_rtl_p);
VALUE *rb_iseq_original_iseq(const rb_iseq_t *iseq, int iseq_rtl_p);
...
unsigned int rb_iseq_line_no(const rb_iseq_t *iseq, size_t pos, int rtl_p);
void rb_iseq_trace_set(const rb_iseq_t *iseq, rb_event_flag_t turnon_events);
void rb_iseq_trace_set_all(rb_event_flag_t turnon_events);
void rb_iseq_trace_on_all(void);
void rb_iseq_insns_info_encode_positions(const rb_iseq_t *iseq, int rtl_p);
